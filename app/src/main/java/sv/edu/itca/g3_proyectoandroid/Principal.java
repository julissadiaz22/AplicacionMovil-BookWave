...
public class Principal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_principal);  // Establecer el layout de la actividad
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction().replace(R.id.frame_layout, new BooksFragment()).commit();
    ...
    private void setupNavigationView() {
        navigationView.setNavigationItemSelectedListener(item -> {
            ...
            else if (item.getItemId() == R.id.nav_agg) {
                selectedFragment = new FragmentAgregarLibros();
            } else if (item.getItemId() == R.id.nav_cultura) {
                selectedFragment = new FragmentAgregarActividades();
            }else if (item.getItemId() == R.id.nav_agusuarios) {
                    selectedFragment = new FragmentAgregarUsuarios();
    ...
    private void setupBottomNavigation() {
        bottomNavigationView.setOnItemSelectedListener(item -> {
            ...
            if (item.getItemId() == R.id.libros) {
                ...
                selectedFragment = new ActividadesFragment();
