...
public class ActividadesAdapter extends RecyclerView.Adapter<ActividadesAdapter.ActividadesViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ActividadesViewHolder holder, int position) {
        ...
        holder.buttonViewMore.setOnClickListener(v -> {
            try {
                ...
                Intent intent = new Intent(context, DetailActividades.class);
    ...
    public void setActividades(List<Actividades> nuevasActividades) {
        this.actividadesList = nuevasActividades; // Actualiza la lista de actividades
