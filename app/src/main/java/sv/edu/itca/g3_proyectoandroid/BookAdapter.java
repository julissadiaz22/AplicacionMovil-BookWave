...
public class BookAdapter extends RecyclerView.Adapter<BookAdapter.BookViewHolder> {
    ...
    public BookAdapter(Context context, List<Libro> bookList) {
    ...
    public void onBindViewHolder(@NonNull BookViewHolder holder, int position) {
        ...
        holder.buttonViewMore.setOnClickListener(v -> {
            try {
                ...
                Intent intent = new Intent(context, DetailLibros.class);
    ...
    public void setLibros(List<Libro> nuevosLibros) {
        this.bookList = nuevosLibros; // Actualiza la lista de libros en el adaptador
